...
library(dplyr)
library(Hmisc)
describe(select(stats, kickerGrade, transPos, playerAssignment, fitPrice))
```
...
```{r warning=FALSE, message=FALSE}
describe(select(matches, matchResult, goalsHome, goalsVisitors, homeChances, visitorsChances))
```
